                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4 flex items-center justify-between space-x-2">
                            ...
                            @else
                            <button type="button" id="{{$offer->id}}" class="ask_to_join_button flex-1 bg-red-500 text-white py-2 px-4 rounded-md text-center cursor-pointer font-medium hover:bg-red-600">Cancel Demand</button>
                            @endif
                        </div>
                    </div>
                </div>
