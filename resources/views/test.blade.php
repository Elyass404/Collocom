            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition duration-300 hover:shadow-xl">
                    <div class="relative h-48">
                        <img src="/api/placeholder/400/300" alt="Modern apartment" class="w-full h-full object-cover">
                        <div class="absolute top-0 right-0 bg-indigo-600 text-white px-3 py-1 m-2 rounded-md text-sm font-semibold">
                            New
                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900">Modern Downtown Apartment</h3>
                        <p class="mt-2 text-gray-600">Stylish apartment in the heart of the city with all amenities included.</p>
                        <div class="mt-4 flex items-center justify-between">
                            <span class="text-indigo-600 font-bold text-lg">$120/night</span>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition duration-300 hover:shadow-xl">
                    <div class="relative h-48">
                        <img src="/api/placeholder/400/300" alt="Cozy cottage" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900">Cozy Countryside Cottage</h3>
                        <p class="mt-2 text-gray-600">Peaceful retreat in the countryside, perfect for a weekend getaway.</p>
                        <div class="mt-4 flex items-center justify-between">
                            <span class="text-indigo-600 font-bold text-lg">$95/night</span>
                            <a href="#" class="text-indigo-600 hover:underline">View Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition duration-300 hover:shadow-xl">
                    <div class="relative h-48">
                        <img src="/api/placeholder/400/300" alt="Luxury villa" class="w-full h-full object-cover">
                        <div class="absolute top-0 right-0 bg-green-600 text-white px-3 py-1 m-2 rounded-md text-sm font-semibold">
                            Featured
                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900">Luxury Beach Villa</h3>
                        <p class="mt-2 text-gray-600">Stunning beachfront villa with private pool and amazing ocean views.</p>
                        <div class="mt-4 flex items-center justify-between">
                            <span class="text-indigo-600 font-bold text-lg">$350/night</span>
                            <a href="#" class="text-indigo-600 hover:underline">View Details</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl">How PropertyHub Works</h2>
                <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-lg shadow-md text-center feature-card">
                    ...
                    <p class="mt-4 text-gray-600">Communicate directly with property owners to discuss details and arrange your stay.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-lg shadow-md text-center feature-card">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900">Enjoy Your Stay</h3>
                    <p class="mt-4 text-gray-600">Book securely through our platform and enjoy your perfect temporary home.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <a href="#" class="group">
                    <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
                        ...
                        <div class="p-4 bg-indigo-600 text-white text-center">
                            <h3 class="text-lg font-semibold">Apartments</h3>
                            <p class="text-sm text-indigo-100">25 listings</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="group">
                    <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
                        <div class="relative h-40">
                            <img src="/api/placeholder/300/200" alt="Houses" class="w-full h-full object-cover group-hover:opacity-90 transition-opacity">
                        </div>
                        <div class="p-4 bg-indigo-600 text-white text-center">
                            <h3 class="text-lg font-semibold">Houses</h3>
                            <p class="text-sm text-indigo-100">18 listings</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="group">
                    <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
                        <div class="relative h-40">
                            <img src="/api/placeholder/300/200" alt="Villas" class="w-full h-full object-cover group-hover:opacity-90 transition-opacity">
                        </div>
                        <div class="p-4 bg-indigo-600 text-white text-center">
                            <h3 class="text-lg font-semibold">Villas</h3>
                            <p class="text-sm text-indigo-100">12 listings</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="group">
                    <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
                        <div class="relative h-40">
                            <img src="/api/placeholder/300/200" alt="Cottages" class="w-full h-full object-cover group-hover:opacity-90 transition-opacity">
                        </div>
                        <div class="p-4 bg-indigo-600 text-white text-center">
                            <h3 class="text-lg font-semibold">Cottages</h3>
                            <p class="text-sm text-indigo-100">8 listings</p>
                        </div>
                    </div>
                </a>
            </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
                    Read testimonials from our satisfied hosts and guests
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md testimonial-card">
                    ...
                    <p class="text-gray-600 italic">"As a host, I've been able to connect with wonderful guests from around the world. The platform makes it easy to manage my listings and the support team is always responsive."</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md testimonial-card">
                    <div class="flex items-center mb-4">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-semibold text-gray-900">Emma Wilson</h4>
                            <div class="flex text-yellow-400">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                </svg>
                    ...
                    <p class="text-gray-600 italic">"Found a beautiful cottage for our family vacation. The photos were accurate and the place was exactly what we needed. Will definitely use PropertyHub again for our next trip!"</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
                <div class="mb-8 lg:mb-0">
                    <h2 class="text-3xl font-extrabold text-white sm:text-4xl">
                        Stay Updated with PropertyHub
                    </h2>
                    <p class="mt-4 text-lg text-indigo-100">
                        Subscribe to our newsletter to receive the latest property listings, updates, and travel tips directly to your inbox.
                    </p>
                </div>
                <div>
                    <form class="sm:flex">
            ...
            <div class="bg-indigo-700 rounded-2xl shadow-xl overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4">
                <div class="pt-10 pb-12 px-6 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
                    <div class="lg:self-center">
                        <h2 class="text-3xl font-extrabold text-white sm:text-4xl">
                            <span class="block">Ready to find your next home?</span>
                            <span class="block">Start browsing today.</span>
                        </h2>
                        <p class="mt-4 text-lg leading-6 text-indigo-100">
                            Join thousands of satisfied users who have found their perfect temporary home through PropertyHub. Create an account to start your journey.
                        </p>
                ...
                <div class="relative -mt-6 aspect-w-5 aspect-h-3 md:aspect-w-2 md:aspect-h-1">
                    <img class="transform translate-x-6 translate-y-6 rounded-md object-cover object-left-top sm:translate-x-16 lg:translate-y-20" src="/api/placeholder/600/400" alt="App screenshot">
                </div>
            </div>
        </div>
    </section>
